...
| 케이스 | LLM | 도구 | 조건 |
|--------|-----|------|------|
| Case 1 | GPT-5.4 | Codex | A |
| Case 2 | GPT-5.4 | Codex | B |
| Case 3 | Gemini | Gemini Code Assist | A |
| Case 4 | Gemini | Gemini Code Assist | B |
| Case 5 | Claude Sonnet | Claude Code | A |
| Case 6 | Claude Sonnet | Claude Code | B |
